...
#include <limits>
#include "include/QSS_DE_FMI.hpp"
...
using namespace cadmium::QSS_DE_FMI;

int main(int argc, char *argv[]) {

	auto model = std::make_shared<QSS_DE_FMI>("QSS_DE_FMI");
#ifdef RT_ARM_MBED
	...
	rootCoordinator.setLogger<cadmium::CSVLogger>("DEVS_FMI_OutputLog.csv",";");
#endif

	rootCoordinator.start();
// 	rootCoordinator.simulate(std::numeric_limits<double>::infinity());
	rootCoordinator.simulate(200.0); // run simulation for 10s
