...
The GenrFMU directory has Parameter Generator model exported by MS4ME tool and KinaseChain dirctory has model exported by OpenModelica. The implementation for importer for Cadmium is included in the forked verion (added as submodule in this repo) of cadmium_v2.
...
Step 1 : git clone along with the forked Cadmium Version 
...
Note : The FMI importer in Cadmium is also tested for models exported from other tools like Simulink which support FMIV2.0.
